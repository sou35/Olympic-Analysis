...
image = Image.open('Olympic_rings_without_rims.svg.png')
...
if user_menu == 'Athlete wise Analysis':
    ...
    fig = ff.create_distplot([x1,x2,x3,x4],['Overall Age','Gold Medalist','Silver Madelist', 'Bronze Medalist'],show_hist=False,show_rug=False)
